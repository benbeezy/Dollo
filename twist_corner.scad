...
///////////////////// FOCUS ON THIS NOW //////////////////////////////
	...
	module wrap_add(){
				translate([-15,33,-15]) rotate([0,0,-90]) mirror([0,0,1]) cube([7,32,.5]);
				translate([-15,33,-15]) rotate([-90,0,-90]) mirror([0,0,1]) cube([7,32,.5]);
	}
...
module arm_movement(){
	...
	difference(){
		translate([-95,-95,30]) rotate([0,0,45]) cube([45,45,(30*2)-1], center=true);
